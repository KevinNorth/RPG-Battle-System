...
public class EndOfBattleLogicState
        extends LogicState<BattleState, BattleAction,
        BattleLogicMachineTransitionAction, BattleConfiguration> {

    public EndOfBattleLogicState(LogicMachine<BattleState, BattleAction, BattleLogicMachineTransitionAction, BattleConfiguration> stateMachine) {
        super(stateMachine);
    }
